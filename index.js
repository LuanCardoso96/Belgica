...
const dict = {
    ...
    en: {
        ...
        "hero.kicker":"Subcontracting • Formwork • Rebar","hero.title":"Engineering that wins contracts and delivers quality","hero.lead":"We are <strong>JF SILVA CONSTRUÇÕES</strong>, a company with <strong>200+ professionals</strong> focused on concrete structures, formwork and rebar. We serve general contractors with agility, safety and competitive cost.","hero.cta":"Request a quote","hero.secondary":"See projects",
    ...
    ja: {
        ...
        "hero.kicker":"下請け • 型枠 • 鉄筋","hero.title":"契約を獲得し品質を届けるエンジニアリング","hero.lead":"私たちは <strong>JF SILVA</strong>、<strong>200名以上</strong> のプロで構成された企業です。コンクリート構造・型枠・鉄筋に特化し、ゼネコン様へ機動力と安全性、競争力のあるコストで提供します。","hero.cta":"見積もり依頼","hero.secondary":"実績を見る",
